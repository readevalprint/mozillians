...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('taskboard_task', 'slug', self.gf('django.db.models.fields.SlugField')(default='', max_length=255, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Task.slug'
        db.delete_column('taskboard_task', 'slug')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 25, 18, 59, 8, 616270)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 25, 18, 59, 8, 616157)'}),
        ...
        'taskboard.task': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'default': "''", 'max_length': '255', 'db_index': 'True'}),
